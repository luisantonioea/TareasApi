...
6. Abre tu navegador y navega a la URL indicada en la terminal agregando `/swagger` al final (por ejemplo: `http://localhost:5187/swagger`).
...
**Integración Externa:**
* `GET /api/tareas-externas` - Obtiene y mapea la lista de tareas desde JSONPlaceholder.
* `GET /api/tareas-externas/{id}` - Obtiene una tarea externa específica.
